  ...
  <div id="multiple-question">
    ...
    <div class="options-show-area">
      <div class="question-title-show-area">
        <h2>{{ index + 1 }}、(多选题) {{ $store.state.questions[index].title }} ({{ must }})</h2>
      </div>
...
#multiple-question .confirm-deleting-question-box {
  z-index: 999;
  width: 300px;
  height: 120px;
...
#multiple-question .confirm-deleting-question-box .btn-area {
  display: flex;
  justify-content: center;
  align-items: center;
}

#multiple-question .confirm-deleting-question-box .btn-area .cancel-btn {
  display: flex;
  align-items: center;
  justify-content: center;
...
#multiple-question .confirm-deleting-question-box .btn-area .cancel_active {
  border: solid 2px #a1a1a1;
  background-color: #a1a1a1;
  color: #fff;
}

#multiple-question .confirm-deleting-question-box .btn-area .confirm-btn {
  margin-left: 30px;
  display: flex;
  align-items: center;
  justify-content: center;
...
#multiple-question .confirm-deleting-question-box .btn-area .confirm_active {
  border: solid 2px #bd0101;
  background-color: #bd0101;
  color: #fff;
}

#multiple-question .options-show-area {
  display: flex;
  flex-direction: column;
  /*align-items: center;*/
  /*justify-content: center;*/
...
#multiple-question .options-show-area .add-option-btn {
  margin-top: 10px;
}

#multiple-question .options-show-area .options-list img,
#multiple-question .options-show-area .add-option-btn img {
  width: 20px;
  height: 20px;
  cursor: pointer;
}

#multiple-question .options-show-area .question-title-show-area h2 {
  font-size: 25px;
...
#multiple-question .options-show-area .add-option-btn .option-add-hint {
  cursor: default;
}

#multiple-question .options-show-area .options-list {
  display: flex;
  justify-content: center;
  align-items: center;
  flex-direction: column;
...
#multiple-question .options-show-area .beyond_limit {
  color: red;
}

#multiple-question .options-show-area .options-list li {
  margin-bottom: 5px;
}
